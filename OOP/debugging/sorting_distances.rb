...
# When the .sort method is invoked it searches the class for a <=> method to compare the objects in the array. 
# As this doesn't exit, the Length objects in the array cannot be compared. You can add a custom class to do this
# which performs a similar operation to the .sort method. However, this sort method will focus on comparing the 
# objects' converted units with one another.
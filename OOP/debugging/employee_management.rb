...
# The attr_reader :serial getter method was placed in the private area which meant it could not be invoked when '==' method
# was called. Private methods cannot be explicity called even in their own class. A protected method could be used in place
# protected methods cannot be called outside of thier class but they can be called within the class. As 'other' is of the 
# same class, it can invoked the ':serial' getter method. 